...
export const cardData = [
  {
    ...
    icon: <Image className="object-contain" src={'/doubleRigthChevron.svg'} alt="chevron_right" width={50} height={50}></Image>
  },
  {
    ...
    icon: <Image className="object-contain" src={'/green.svg'} alt="chevron_right" width={50} height={50}></Image>
  },
  {
    title: "Quick and Easy Scheduling",
    ...
    icon: <Image className="object-contain" src={'/secure.svg'} alt="chevron_right" width={50} height={50}></Image>
  }
]
