...
function TrendingChip({trending}:{trending:string}) {
    return (
        <div className="w-fit bg-gray-200 rounded-full p-2 flex items-center space-x-2">
            ...
            <span className="mx-2 font-semibold text-gray-500 w-fit whitespace-nowrap">{trending}</span>
